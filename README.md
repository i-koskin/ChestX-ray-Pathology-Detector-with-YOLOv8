...
- ⚖️ Модель со всеми классами заболеваний vs Бинарная модель (Abnormal / Normal)
- 🚀 Обучение YOLOv8 (nano/small/medium)
- 📊 Оценка качества (mAP50, mAP50-95)

## 😢 Проблема

Исходная многоклассовая модель показывала низкий mAP50 (~0.2) из-за малого количества данных.
